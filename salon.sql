...
INSERT INTO public.appointments VALUES (1, 1, 3, 'teraz');
...
INSERT INTO public.customers VALUES (8, '123', 'dupa');
...
INSERT INTO public.services VALUES (1, 'mycie');
INSERT INTO public.services VALUES (2, 'strzyzenie meskie');
INSERT INTO public.services VALUES (3, 'strzyzenie kobiece');
...
--
-- Name: appointments customerfk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT customerfk FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments servicefk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT servicefk FOREIGN KEY (service_id) REFERENCES public.services(service_id);
